...
class DocumentComparatorLLM:
    def __init__(self):
        try:
            ...
            self.log.info("DocumentComparatorLLM initialized successfully with LLM and Parser.")
        except Exception as e:
            self.log.error(f"Error in DocumentComparatorLLM initialization: {e}")
            raise DocumentPortalException("An error occurred while initializing DocumentComparatorLLM.",sys)
